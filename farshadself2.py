...
feri = 'BABvIIIeZGikA3S6pHModDuaTCtfpaJXYZDjDJ0i11ROvoTaEqsYYCYjFfPwC6Ee1iJ6c9QZ537keuLy8Y6aNGTutexNt6wdhuNwMB0xqgQoMCTOe0dDmygfmVBSCTCrTNzkAy5D6zyWd7XQbcs909jt9gtynHvzWAGE2Rfu2mLhqwvEo_dBCRVpcVy_S2ovR9gi9l01YwI0unjzfRhnePpIrg4LyJay1PttzcP_o3XnptYBOyw_HbXWYAQ7bUB0X--8-eF11WZFJyPOz70181QCNC7iqTcCqMe_3JgzS0TV-XOwp2S8y7S4HZAkXm6q8II888-nxnnCyfwiv-sfwA3pAAAAAH30Hh0A'
...
def unblock_user(client,message):
    ...
    message.edit_text(f'**[{name}](tg://user?id={message.reply_to_message.from_user.id})**')
